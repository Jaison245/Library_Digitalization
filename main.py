...
def check_lib(lib, unique_words, word_to_books, sort_output=True):
    dw1 = lib.distinct_words("bookA")
    dw2 = lib.distinct_words("bookB")
    ...
    if lib.count_distinct_words("bookA") == len(unique_words[0]) and lib.count_distinct_words("bookB") == len(unique_words[1]):
